...
module.exports = function (lat, lon, callback) {
  var everyTrailUrl = 'http://' + process.env.EVERYTRAIL_KEY + ':' + process.env.EVERYTRAIL_SECRET + '@www.everytrail.com/api/trip/search?limit=100&proximity=20&lat=' + lat + '&lon=' + lon;
